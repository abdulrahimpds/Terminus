...
namespace YimMenu::CrashSignatures
{
	...
	inline void PrePopulateExistingTasks()
	{
		...
		static const std::vector<std::tuple<int,int,int,int>> validTasks = {
			...
			{2, 10, 428, 11}, {2, 11, 430, 12}, {3, 1, 613, 2}, {3, 0, 261, 1}, {2, 2, 583, 4},
			...
			{3, 10, 428, 11}, {3, 10, 430, 11}, {3, 10, 613, 11}, {3, 11, 430, 12}, {2, 0, 618, 2},
			...
			{4, 4, 76, 4}, {4, 4, 281, 4}, {4, 4, 430, 4}, {4, 5, 48, 5}, {4, 0, 567, 2},
			...
			{4, 12, 430, 12}, {4, 2, 31, 2}, {0, 2, 31, 2}, {2, 2, 576, 4}, {1, 0, 46, 2},
			...
			{3, 2, 147, 1}, {3, 3, 48, 255}, {2, 2, 588, 3}, {2, 0, 138, 5}, {0, 1, 580, 1},
			...
			{1, 1, 589, 1}, {1, 1, 580, 1}, {4, 1, 216, 1}, {3, 2, 436, 4}, {3, 3, 544, 255},
			...
			{3, 9, 76, 10}, {3, 2, 523, 7}, {3, 6, 427, 7}, {3, 4, 427, 5}, {1, 1, 604, 2},
			...
			{1, 1, 604, 7}, {0, 1, 587, 2}, {3, 0, 509, 1}, {4, 3, 449, 3}, {3, 0, 147, 0},
			...
			{4, 0, 80, 6}, {2, 0, 113, 4}, {0, 1, 601, 1}, {4, 2, 257, 1}, {3, 1, 53, 0},
            {2, 4, 438, 5}, {2, 6, 48, 6}, {2, 6, 430, 8}, {2, 7, 48, 6}, {2, 6, 238, 7},
            {0, 1, 605, 2}, {2, 2, 76, 3}, {2, 2, 154, 3}, {4, 4, 428, 4}, {2, 3, 138, 0},
			{2, 2, 428, 2}, {2, 3, 564, 4}, {2, 6, 437, 6}, {2, 1, 4, 3}, {1, 1, 589, 2},
			{0, 0, 576, 2}, {0, 0, 32, 2}, {0, 1, 48, 3}, {2, 2, 437, 3}, {4, 4, 517, 4},
			{4, 0, 8, 0}, {4, 6, 238, 6}, {4, 2, 427, 2}, {2, 4, 281, 4}, {4, 0, 142, 6},
			{1, 1, 154, 2}, {0, 0, 451, 6}, {0, 2, 576, 8}, {1, 0, 31, 3}, {2, 2, 587, 4},
			{3, 0, 221, 1}, {4, 1, 237, 0}, {0, 1, 385, 1}, {0, 1, 604, 4}, {1, 0, 76, 4},
			{2, 4, 4, 5}, {2, 9, 427, 10}, {0, 1, 587, 3}, {2, 8, 427, 9}, {1, 1, 589, 3},
			{1, 2, 428, 4}, {3, 0, 5, 2}, {3, 1, 185, 3}, {3, 1, 32, 3}, {2, 2, 571, 3},
			{2, 2, 583, 1}, {2, 7, 427, 9}, {2, 2, 576, 1}, {1, 1, 576, 2}, {1, 1, 576, 3},
			{2, 2, 579, 4}, {2, 2, 601, 4}, {0, 2, 35, 2}, {0, 3, 34, 3}, {1, 0, 221, 1},
			{2, 4, 76, 255}, {2, 1, 582, 1}, {3, 1, 77, 1}, {3, 0, 470, 1}, {1, 0, 4, 4},
			{1, 1, 188, 5}, {1, 0, 12, 3}, {3, 4, 176, 4}, {2, 2, 32, 4}, {3, 3, 147, 4},
			{3, 0, 23, 1}, {3, 1, 427, 2}, {3, 0, 412, 0}, {3, 3, 572, 8}, {3, 1, 438, 1},
			{3, 1, 437, 1}, {3, 1, 437, 0}, {0, 0, 154, 0}, {3, 4, 634, 5}, {4, 0, 31, 8},
			{3, 4, 412, 0}, {1, 0, 594, 255}, {1, 1, 587, 255}, {3, 1, 433, 1}, {3, 3, 547, 1},
			{3, 3, 572, 1}, {1, 3, 428, 5}, {3, 6, 1, 6}, {3, 4, 4, 5}, {3, 0, 435, 9},
			{3, 4, 187, 5}, {3, 5, 237, 5}, {4, 0, 176, 6}, {2, 0, 39, 3}, {2, 0, 39, 2},
			{2, 0, 39, 4}, {2, 2, 588, 6}, {2, 2, 588, 8}, {2, 0, 39, 1}, {3, 11, 613, 12},
			{3, 3, 23, 0}, {0, 1, 581, 5}, {1, 2, 48, 5}, {4, 0, 176, 3}, {3, 0, 23, 0},
			{3, 1, 427, 1}, {1, 1, 583, 3}, {1, 1, 583, 6}, {3, 1, 77, 2}, {2, 0, 474, 4},
			{2, 2, 576, 8}, {2, 1, 539, 3}, {2, 3, 524, 5}, {2, 4, 526, 6}, {2, 5, 572, 7},
        	{2, 6, 48, 9}, {2, 8, 238, 10}, {2, 0, 616, 2}, {3, 0, 436, 6}, {3, 0, 113, 1},
			{2, 2, 523, 6}, {2, 3, 633, 7}, {2, 4, 634, 8}, {0, 1, 583, 8}, {2, 3, 547, 7},
        	{0, 0, 150, 7}, {0, 1, 154, 8}, {0, 0, 451, 7}, {0, 2, 576, 9}, {2, 5, 238, 5},
			{3, 0, 594, 4}, {2, 2, 147, 2}, {2, 1, 185, 2}, {2, 3, 35, 3}, {2, 4, 34, 4},
			{0, 1, 605, 4}, {0, 0, 150, 3}, {1, 1, 583, 4}, {2, 2, 605, 6}, {4, 3, 86, 3},
			{2, 1, 113, 3}, {4, 1, 191, 0}, {2, 3, 545, 4}, {2, 4, 193, 5}, {3, 0, 488, 0},
			{0, 0, 35, 0}, {2, 1, 594, 8}, {2, 2, 582, 9}, {2, 2, 583, 9}, {2, 3, 428, 1},
			{4, 4, 548, 4}, {1, 1, 589, 5}, {2, 0, 121, 3}, {1, 0, 46, 0}, {1, 1, 257, 1},
			{2, 0, 39, 0}, {3, 0, 268, 0}, {2, 4, 436, 5}, {2, 3, 547, 255}, {1, 1, 587, 3},
        	{2, 0, 450, 1}
		};
